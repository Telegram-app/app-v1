...
export default defineComponent({
  ...
  setup() {
    ...
    return {userStore, modules: [FreeMode]};
  },
  ...
  data: () => ({
    links: [
      {icon: 'premoder', title: 'Awaiting pre-moderation', metaTitle: undefined, meta: 17, to: '#'},
      {icon: 'orders', title: 'Orders', metaTitle: 'Orders awaiting attention', meta: 10, to: '#'},
      {icon: 'finances', title: 'Finances', metaTitle: 'Balance', meta: 100, to: '#'},
      {icon: 'products', title: 'Products', metaTitle: 'Active', meta: 50, to: '#'},
      {icon: 'reviews', title: 'Reviews', metaTitle: 'New in the last 24 hours', meta: 10, to: '#'},
      {icon: 'staff', title: 'Staff', metaTitle: 'Active employees in the last 24 hours', meta: 5, to: '#'},
      {icon: 'clients', title: 'Clients', metaTitle: undefined, meta: undefined, to: '#'},
      {icon: 'messenger', title: 'Messenger', metaTitle: 'Unread messages', meta: 5, to: '#'},
      {icon: 'statistics', title: 'Statistics', metaTitle: undefined, meta: undefined, to: '#'},
      {icon: 'activity-log', title: 'Activity log', metaTitle: 'Actions in the last 24 hours', meta: 10, to: '#'},
      {icon: 'settings', title: 'Settings', metaTitle: undefined, meta: undefined, to: '#'},
    ]
  }),
